  ...
  <div class="bottom-grid">
    ...
    <div>
      <div class="validity-note" style="margin:0 0 24px;">
        ...
        Dari {{ $totalParticipants }} peserta, data telah diagregasi sepenuhnya untuk membentuk skor tim kolektif ini. Pastikan tingkat penyelesaian grup minimal mewakili tim secara wajar untuk menghindari simpangan data.
      </div>
    </div>
  </div>
