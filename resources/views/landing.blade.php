...
<nav class="nav">
  <div class="nav-inner">
    ...
    <div class="nav-cta" style="display: flex; align-items: center; gap: 12px;">
      @auth
        <a href="{{ route('pilih-tes') }}" class="btn btn-primary">Mulai Tes</a>
        ...
        <div class="dropdown" style="position: relative;">
          ...
          <div id="userDropdown" class="user-dropdown-menu">
            <a href="{{ route('dashboard') }}" class="user-dropdown-item" style="border-bottom: 1px solid #f0f2f8;">Dashboard</a>
            <a href="{{ route('profile.edit') }}" class="user-dropdown-item" style="border-bottom: 1px solid #f0f2f8;">Profil Saya</a>
      ...
      @else
        <a href="{{ route('dashboard') }}" class="btn btn-ghost">Masuk</a>
        <a href="{{ route('pilih-tes') }}" class="btn btn-primary">Mulai Tes</a>
      @endauth
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="grid grid-3">
      <div class="price-card">
        ...
        <a href="{{ route('assessment.test') }}" class="btn btn-ghost btn-block">Mulai Tes</a>
      </div>
      <div class="price-card featured">
        ...
        <a href="{{ route('assessment.test') }}" class="btn btn-primary btn-block">Mulai Tes</a>
      </div>
      <div class="price-card">
        <h3>Tim / Korporasi</h3>
...
<footer>
  <div class="container">
    <div class="foot-grid">
      <div>
        <div class="brand" style="margin-bottom:10px;"><img class="brand-icon" src="{{ asset('assets/img/logo-icon.png') }}" alt="IMT Discovery"> IMT DISCOVERY</div>
      ...
      <div><h4>Produk</h4><a href="{{ route('assessment.test') }}">Tes Personal</a><a href="team.html">Tes Korporasi</a><a href="#pricing">Harga</a></div>
