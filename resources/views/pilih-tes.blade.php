...
<nav class="nav">
  <div class="nav-inner">
    <div class="brand"><a href="{{ route('home') }}" style="text-decoration:none; color:inherit; display:flex; align-items:center; gap:8px;"><img class="brand-icon" src="{{ asset('assets/img/logo-icon.png') }}" alt="IMT Discovery"> IMT DISCOVERY</a></div>
    <div class="nav-cta">
      <a href="{{ route('home') }}" class="btn btn-ghost btn-sm">Kembali ke Beranda</a>
    </div>
  </div>
</nav>
...
<div class="select-container">
  ...
  <div class="select-grid">
    <!-- Card Personal -->
    <a href="{{ route('assessment.test') }}?type=personal" class="select-card personal">
    ...
    <!-- Card Grup -->
    <a href="{{ route('assessment.test') }}?type=group" class="select-card group">
      <div class="select-icon">🏢</div>
