...
<div class="grid grid-cols-1 <?php echo e(auth()->user()->role === 'super_admin' ? 'md:grid-cols-4' : 'md:grid-cols-2'); ?> gap-6 mb-8">
...
<?php else: ?>
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
    <h2 class="text-xl font-bold text-gray-800 mb-4">Selamat datang, <?php echo e(auth()->user()->name); ?>!</h2>
