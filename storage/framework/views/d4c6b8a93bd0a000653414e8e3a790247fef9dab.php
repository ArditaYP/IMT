...
<div class="no-print" style="max-width:1100px; margin:16px auto 0; padding:0 24px; display:flex; justify-content:space-between; align-items:center;">
  <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-ghost" style="flex:1;">Tutup</a>
...
<div id="lockedView" style="max-width:640px; margin:80px auto; text-align:center; display:none;">
  <div class="q-card">
    ...
    <a href="<?php echo e(route('assessment.test')); ?>" class="btn btn-primary">Mulai / Lanjutkan Tes</a>
  </div>
</div>
  ...
  <div class="ov-header">
    ...
    <div class="ov-meta" style="display:flex; align-items:center; gap:16px;">
      ...
      <div style="width:64px; height:64px; border:1px solid #e7e9f2; border-radius:6px; padding:2px; background:#fff; display:flex; justify-content:center; align-items:center;">
        <?php echo QrCode::size(58)->generate(route('assessment.laporan', ['uuid' => $assessment->uuid])); ?>
...
<?php /**PATH C:\Users\CSO KUTA 2\Documents\web\IMT\resources\views/report.blade.php ENDPATH**/ ?>