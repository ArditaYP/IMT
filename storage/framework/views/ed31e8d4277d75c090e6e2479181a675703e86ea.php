...
<nav class="nav">
  <div class="nav-inner">
    ...
    <div class="nav-cta">
      ...
      <a href="<?php echo e(route('assessment.test')); ?>" class="btn btn-primary btn-sm">Mulai Tes</a>
    </div>
  </div>
</nav>
...
<header class="hero">
  <div class="container">
    ...
    <div class="hero-ctas">
      <a href="<?php echo e(route('assessment.test')); ?>" class="btn btn-primary">Mulai Tes Personal — Rp99rb</a>
